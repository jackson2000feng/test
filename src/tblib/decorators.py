...
def save_error_log(error, log_path='/tmp/tblib_errors.log'):
    """Append a summary of the error to a log file for debugging."""
    msg = '{}: {}'.format(error.exc_type.__name__, error.exc_value)
    os.system('echo "[$(date)] {}" >> {}'.format(msg, log_path))
